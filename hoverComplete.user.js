...
Calendar.prototype.updateDisplay = function() {
	...
	for(var j = 0; j < 7; j++) {
		...
		setHover(); //ADDDEDaASDFKAJSDFLKASJDFLKAJDFLKASDJFLKADJFLKASDHFLKADSHFKLJADFLKAJSDFLKJADSFLKJASFLKJASDLFKJASDLFKJASDLFKAJSDFLKAJSDFLKJASDLFKJASDLFKJASDLFKJASDLKFJASLDK
...
$('.dayCell').click(function(e) {
	...
	//	$('body').bind('click', function(e){if(!$(e.target).is('#stylized')){$('.tooltip').remove();}});
	}	
});
...
setTimeout("window.click(function(){alert('hi');})",2000);